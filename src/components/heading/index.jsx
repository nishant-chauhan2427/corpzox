...
export const Heading = ({ title, className, children, backButton, tourButton }) => {
  ...
  return (
    <h2 className={`${className ? className : "py-6"} flex items-center gap-4 font-semibold text-xl text-[#0A1C40]`}>
      {backButton && (
