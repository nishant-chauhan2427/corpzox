    ...
    <>
      {to ? (
        <Link
          ...
          } hover:bg-[#FFD700] hover:shadow-lg rounded-md flex items-center gap-4 text-black group transition-all duration-300 ease-in-out hover:transition-all hover:duration-300 hover:ease-in-out`}
          onClick={onClick}
        >
