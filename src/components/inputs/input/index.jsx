    ...
    <>
      ...
      {/* <div class={` w-full relative + ${className}`}>
        <input
          ...
          } ${leftIcon} block w-full text-sm text-bee-black dark:text-bee-white bg-bee-paleGray dark:bg-bee-ebonyGem rounded-lg border-1 border-gray-300 appearance-none dark:border-bee-primary dark:focus:border-bee-primary focus:outline-none focus:border-bee-primary peer + ${className}`}
          placeholder=" "
          autoComplete="off"
          required={required}
          // style={style}
          ...
          // onFocus={handleFocus}
          // onClick={handleClick}
          onKeyPress={(e) => validationMethod(e)}
        />
        <label
          for={label}
          class={`${leftIcon ? "mx-3" : "px-2"} ${
            labelIcon ? "flex justify-center items-center px-2.5" : "px-2"
          }
          } absolute rounded-lg text-sm text-gray-400 dark:text-gray-400 duration-300 transform -translate-y-4 scale-75 top-2 origin-[0] bg-bee-paleGray dark:bg-bee-ebonyGem peer-focus:px-2 peer-focus:text-bee-primary peer-focus:dark:text-bee-primary peer-placeholder-shown:scale-100 peer-placeholder-shown:-translate-y-1/2 peer-placeholder-shown:top-1/2 peer-focus:top-2 peer-focus:scale-75 peer-focus:-translate-y-4 left-3 + ${labelClassName}`}
        >
          <span className="mr-2">{labelIcon}</span>
          {label}
        </label>
