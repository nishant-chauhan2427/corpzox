...
const SelectUserType = () => {
  ...
  const handleCardClick = (index) => {
    setClickedCardIndex(index); // Set clicked card index
    setIsCardClicked(true); // Set isCardClicked to true when a card is clicked
    if (index === 0) {
      localStorage.setItem("investType", "Investment as an individual");
    } else {
      localStorage.setItem("investType", "Invest as an FI");
    }
  };
