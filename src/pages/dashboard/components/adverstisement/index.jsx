    ...
    <>
      {isVisible && (
        <div className="relative min-w-[350px]">
          <div
            className={`flex flex-col gap-4 rounded-[18px] px-5 py-4 pr-16 bg-[url("/images/advertisement/advertisement-bg.svg")] bg-no-repeat bg-conver bg-right-bottom  transition-all duration-300 ${
