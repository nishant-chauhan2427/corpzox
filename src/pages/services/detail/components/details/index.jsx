          ...
          <div className="pt-4 flex flex-col md:flex-row items-center gap-4">
            {!pricing && (
              <div className="w-full md:w-3/5 flex flex-col gap-6">
                <h3 style={{ fontFamily: 'MarsCondensed, sans-serif' }} className="font-semibold text-[20px] leading-[18px] uppercase">
            ...
            <div
              ...
              className="w-full  rounded-3xl bg-no-repeat bg-cover"
            >
            ...
            <Features />
              ...
              {serviceDetailLoading ? (
                ...
                success?.documentVideoUrl ||
                success?.stepsVideoUrl ? (
                <video controls autoPlay className="rounded-[10px]">
                  <source
                    src={
                      success.delivrableVideoUrl ||
                      success.documentVideoUrl ||
        ...
        <div className="flex flex-row w-[40%]">
          ...
          >
            <div className="flex flex-col gap-2 px-4 py-5 items-center justify-center ">
              <img
                src="/public/icons/payment/callback.svg"
                width={200}
                alt=""
              />
