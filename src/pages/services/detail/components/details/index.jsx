      ...
      <div className="pt-4 flex flex-col md:flex-row gap-4">
        ...
        <div className="w-full md:w-2/5 bg-[#EEEFF3] box-sg rounded-lg px-5 py-6 gap-2 flex flex-col">
          ...
          <div className="pt-2 flex justify-between items-center gap-2">
            <Button className={"text-xs px-2 py-1 rounded-sm"} outline={true}>Avail services</Button>
            <Button className={"text-xs px-2 py-1 rounded-sm"} primary={true}>Talk to our Advisors</Button>
          </div>
        </div>
      </div>
    </section>
